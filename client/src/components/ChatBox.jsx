...
const ChatBox = () => {
  ...
  const[isPublished, setIsPublisted] = useState(false)
  ...
  return (
    ...
    {mode === 'image' && (
      <label className='inline-flex items-center gap-2 mb-3 text-sm mx-auto'>
        ...
        <input type='checkbox' className='cursor-pointer' checked={isPublished} onChange={(e)=>setIsPublisted(e.target.checked)} />
      </label>
    )}

    {/* Prompt Input ChatBox */}
